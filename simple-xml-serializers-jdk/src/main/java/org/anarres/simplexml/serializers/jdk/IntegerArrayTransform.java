...
public class IntegerArrayTransform implements Transform<int[]>, TransformFactory {
    ...
    @CheckForNull
    public static int[] toObject(@Nonnull String value) throws IOException, ClassNotFoundException {
    ...
    @Nonnull
    public static String toString(@Nonnull int[] value) throws IOException {
        return Joiner.on(",").join(Ints.asList(value));
    }

    @Override
    public int[] read(String value) throws Exception {
